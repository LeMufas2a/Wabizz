...
class ItemsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Store extra three images now
        if ($request->hasFile('item_image_two')) {
            // die("here");
            $item->item_image_two = $this->saveImageVersions(
                $this->imagePath,
                $request->item_image_two,
                [
                    ['name'=>'large', 'w'=>590, 'h'=>400],
                    //['name'=>'thumbnail','w'=>300,'h'=>300],
                    ['name'=>'medium', 'w'=>295, 'h'=>200],
        ...
        if ($request->hasFile('item_image_three')) {
            $item->item_image_three = $this->saveImageVersions(
                $this->imagePath,
                $request->item_image_three,
                [
                    ['name'=>'large', 'w'=>590, 'h'=>400],
                    //['name'=>'thumbnail','w'=>300,'h'=>300],
                    ['name'=>'medium', 'w'=>295, 'h'=>200],
        ...
        if ($request->hasFile('item_image_four')) {
            $item->item_image_four = $this->saveImageVersions(
                $this->imagePath,
                $request->item_image_four,
                [
                    ['name'=>'large', 'w'=>590, 'h'=>400],
                    //['name'=>'thumbnail','w'=>300,'h'=>300],
                    ['name'=>'medium', 'w'=>295, 'h'=>200],
