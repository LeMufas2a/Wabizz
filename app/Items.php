...
class Items extends TranslateAwareModel
{
    ...
    {
        $logoms = array();
        $logoms[0] = $this->getImge($this->image, config('global.restorant_details_image'));
        $logoms[1] = $this->getImge($this->item_image_two, config('global.restorant_details_image'));
        $logoms[2] = $this->getImge($this->item_image_three, config('global.restorant_details_image'));
        $logoms[3] = $this->getImge($this->item_image_four, config('global.restorant_details_image'));
        return $logoms;
